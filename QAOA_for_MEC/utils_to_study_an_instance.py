...
def define_instance(n, instance, verbose):
    ...
    if n == 6:
        all_instances = {
            1: [{4, 6, 7, 9, 10, 11}, {1, 2, 5, 6, 11, 12}, {8, 1, 12}, {2, 3, 5}, 
                {1, 3, 4, 5, 9, 12}, {2, 6, 7, 9, 12}],
            2: [{2, 11, 12, 6}, {2, 4, 6, 8, 9, 11}, {1, 3, 5, 7, 10, 12}, {2, 7}, 
                {2, 3, 4, 5, 8, 12}, {1, 2, 8, 9, 12}],
            3: [{1, 4, 5, 6}, {2, 4, 7, 9}, {3, 5, 8}, {1, 2, 5}, {4, 6, 7}, {8, 1, 3, 6}],
            4: [{5, 7, 9}, {2, 4, 6}, {1, 8, 12}, {6, 3, 9, 10}, {2, 3, 5}, {4, 6}],
            5: [{1, 2, 4, 6}, {7, 8, 10}, {3, 5, 9}, {2, 4, 7}, {6, 8, 12}, {1, 9, 12}],
            6: [{1, 2, 3}, {6, 7, 8}, {4, 5, 9}, {1, 4, 6}, {2, 5, 8}, {3, 7, 9}],
        }
    elif n == 8:
        all_instances = {
            1: [{1, 2, 3, 4, 7, 8, 9, 12, 13, 14}, {1, 4, 5, 8, 9, 12, 13, 14, 16}, 
                {1, 6, 9, 10, 11, 13, 15, 16}, {5, 6, 10, 11, 15, 16}],
            2: [{1, 2, 3, 5, 7, 12, 15}, {6, 7, 8, 9}, {4, 6, 8, 9, 10, 11, 13, 14, 16}, 
                {3, 4, 5, 6, 7, 9, 10, 11, 12, 15}],
            3: [{2, 5, 7, 9, 10, 12}, {1, 3, 6, 8, 11, 13}, {4, 5, 6, 7, 8}, {1, 4, 9, 10, 13, 16}],
            4: [{2, 4, 7, 9}, {5, 8, 10}, {1, 3, 6, 11}, {7, 8, 12, 13}],
            5: [{1, 2, 5, 7}, {6, 9, 10}, {3, 4, 8, 11}, {2, 7, 12}],
            6: [{3, 5, 6, 8, 9}, {1, 2, 4, 7, 12}, {10, 11, 13, 14}, {3, 5, 7, 8}],
        }
    elif n == 10:
        all_instances = {
            ...
            3: [{3, 5, 8, 10, 12, 13, 14, 16}, {1, 2, 7, 9, 11, 15, 18, 20}, {4, 6, 8, 9, 12, 13, 19}, 
                {5, 6, 10, 14, 16}],
            4: [{1, 2, 3, 6, 9, 10, 13}, {4, 5, 8, 11, 14, 17}, {6, 7, 8, 12, 16}, {2, 3, 10, 11, 13}],
            5: [{2, 4, 6, 9, 10, 13}, {3, 5, 7, 11, 14}, {1, 8, 9, 12, 15, 16}, {4, 5, 10, 13, 17}],
            6: [{1, 4, 6, 8, 10, 12, 13}, {2, 3, 7, 9, 11, 14, 16}, {5, 7, 9, 10, 13, 17}, 
                {3, 4, 6, 11, 15}],
        }
    else:
