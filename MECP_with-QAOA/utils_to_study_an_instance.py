...
def define_instance(n, instance, verbose):
    ...
    info : dictionary
        The dictionary containing all the information about the instances studies.
...
#             {1, 2, 4, 6, 7, 8, 9, 12, 13, 15, 17, 18, 20}, {1, 5, 10, 12, 15, 17, 18, 19}],
...
#         10: [{1, 2, 6, 7, 9, 11, 18}, {3, 4, 8, 10, 13, 19, 20}, 
#              { 5, 12, 14, 15, 16, 17}, {1, 2, 5, 6, 7, 9, 11, 12, 14, 15, 16, 17, 18}, 
#              {2, 4, 7, 8, 9, 10, 12, 14, 16, 18}, {1, 4, 7, 8, 10, 13, 18}, 
#              {2, 3, 5, 8, 9, 11, 12, 16, 20}, {1, 4, 7, 8, 11, 12, 13, 14, 18, 19, 20}, 
#              {3, 4, 5, 9, 11, 12, 13, 14, 15, 16, 17}, {2, 5, 7, 8, 13, 18, 19, 20}] 
#         }
